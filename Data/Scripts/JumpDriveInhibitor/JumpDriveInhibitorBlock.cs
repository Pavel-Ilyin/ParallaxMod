...
{
    [MyEntityComponentDescriptor(typeof(Sandbox.Common.ObjectBuilders.MyObjectBuilder_Beacon), false, new string[] { "JumpInhibitor" })]
        ...
        public override void UpdateAfterSimulation10()
        {
            base.UpdateAfterSimulation10();
               try
               {
                   ...
                   if (Settings.General.UseConfigDisplayName)
                   {
                       _beacon.CustomName = Settings.General.DisplayName;
                       _beacon.HudText = Settings.General.DisplayName;
                   }    
