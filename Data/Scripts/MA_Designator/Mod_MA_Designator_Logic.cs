...
namespace MA_Designator_CustomEnergyWeapons{
	...
	public class MA_Designator_Logic : MyGameLogicComponent{
		...
		public void Configuration(){
			...
			Settings.MaxAmmoInInventory = 5; //If ammo in weapon meets or exceeds this number, ammo regeneration will stop.
			...
			*/
			...
			Settings.BeamMinimumRadius = 0.15f; //Minimum Random Beam Radius if UseBeamFlicker is true
			Settings.BeamMaximumRadius = 0.20f; //Maximum Random Beam Radius if UseBeamFlicker is true
			Settings.BeamColors.Add(new Color(0,10,3,30)); //The color of the beam. Copy this line to use other colors in the beam
