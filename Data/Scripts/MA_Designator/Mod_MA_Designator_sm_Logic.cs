	...
	public class MA_Designator_sm_Logic : MyGameLogicComponent{
		...
		public void Configuration(){
			...
			*/
			...
			Settings.BeamRadius = .01f; //The beam radius if UseBeamFlicker is false
			Settings.BeamMinimumRadius = 0.06f; //Minimum Random Beam Radius if UseBeamFlicker is true
			Settings.BeamMaximumRadius = 0.08f; //Maximum Random Beam Radius if UseBeamFlicker is true
